...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'QRscan',
          path: '/qRscan',
          builder: (context, params) => const QRscanWidget(),
        ),
        FFRoute(
          name: 'NAOwait',
          path: '/nAOwait',
          builder: (context, params) => const NAOwaitWidget(),
        ),
        FFRoute(
          name: 'SchedaProdotto',
          path: '/schedaProdotto',
        ...
        FFRoute(
          name: 'Carrello',
          path: '/carrello',
          builder: (context, params) => const CarrelloWidget(),
        ),
        FFRoute(
          name: 'Catalogo',
          path: '/catalogo',
        ...
        FFRoute(
          ...
          builder: (context, params) => const SelectExperienceWidget(),
        ),
        FFRoute(
          name: 'NAOstore',
          path: '/nAOstore',
          builder: (context, params) => const NAOstoreWidget(),
        ),
        FFRoute(
