...
class _NAOwaitWidgetState extends State<NAOwaitWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.risultato = await IniziaDialogoCall.call(
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
            ..complete(GetGioielloConsigliatoCall.call(
              idCliente: FFAppState().idCliente,
              nome: FFAppState().nome,
              cognome: FFAppState().cognome,
            )))
      ...
      builder: (context, snapshot) {
        ...
        final nAOwaitGetGioielloConsigliatoResponse = snapshot.data!;
                      ...
                      Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                              functions.uRLmerge(
                                  'http://192.168.0.170:5010', _model.fotoURL)!,
                              width: 300.0,
                              height: 200.0,
                              fit: BoxFit.cover,
                            ),
