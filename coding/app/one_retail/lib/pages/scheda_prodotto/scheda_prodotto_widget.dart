...
import 'scheda_prodotto_model.dart';
export 'scheda_prodotto_model.dart';

class SchedaProdottoWidget extends StatefulWidget {
  const SchedaProdottoWidget({
    super.key,
    required this.id,
  });
  ...
  @override
  State<SchedaProdottoWidget> createState() => _SchedaProdottoWidgetState();
}

class _SchedaProdottoWidgetState extends State<SchedaProdottoWidget> {
  late SchedaProdottoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SchedaProdottoModel());
  }
