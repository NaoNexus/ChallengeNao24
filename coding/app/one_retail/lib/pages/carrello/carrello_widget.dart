  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final carrelloViewCarrelloResponse = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
          appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  if (!((String data) {
                    ...
                    carrelloViewCarrelloResponse.jsonBody,
                    r'''$.data''',
                  ).toString())))
                    Padding(
                    ...
                    Align(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          ].addToStart(const SizedBox(height: 400.0)),
                        ),
                      ),
                    ),
                ],
