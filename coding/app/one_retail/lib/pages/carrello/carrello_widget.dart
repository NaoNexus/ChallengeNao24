...
export 'carrello_model.dart';

class CarrelloWidget extends StatefulWidget {
  const CarrelloWidget({super.key});
...
class _CarrelloWidgetState extends State<CarrelloWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarrelloModel());
  }
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 12.0),
                              child: Text(
                                'Conferma oppure rimuovi quello che non vuoi più',
                            ...
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final listViewViewCarrelloResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final prodottoCarrello = getJsonField(
