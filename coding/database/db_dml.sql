...
INSERT INTO Oggetto (titolo, 					categoria, 		prezzo, 	descrizione,															foto,																		qta_magazzino, 	qta_scaffale, 	sconto, 	eta_consigliata, 	sesso_consigliato) VALUES
	...
	('dextera hoop earrings', 					'earrings', 	'155.00', 	'Asymmetrical design, Interlocking loop, White, Rhodium plated', 		(''),								6, 				1,				10,			20,					'F'),
	...
	('gema bracalet', 							'bracelet', 	'195.00', 	'Mixed cuts, Blue, Rhodium plated', 									(''),										8, 				1, 				10, 		65, 				'F'),
	...
	('matrix tennis necklace', 					'necklace', 	'250.00', 	'Round cut, Yellow, Gold-tone plated', 									(''),							1, 				1, 				10, 		54, 				'F'),
	...
	('cristalline delight watch', 				'watch', 		'300.00', 	'Swiss Made, Metal bracelet, White, Stainless steel', 					(''),									8, 				0, 				10, 		37, 				'F'),
	...
	('disney mickey mouse pendant', 			'necklace', 	'125.00', 	'White, Rhodium plated', 									  			(''),										3, 				0, 				10, 		84, 				'F'),
	('lucent bangle', 							'bracelet', 	'215.00', 	'Crystals, Magnet, Gold-tone PVD', 									  	(''),										3, 				0, 				10, 		84, 				'F'),
	('lucent hoop earrings', 					'earrings', 	'300.00', 	'Statement, Octagon shape, Pink', 									  	(''),										3, 				0, 				10, 		84, 				'F'),
	('meteora drop earrings', 					'earrings', 	'89.00', 	'White, Rhodium plated', 									  			(''),										3, 				0, 				10, 		84, 				'F'),
	('stilla necklace', 						'necklace', 	'175.00', 	'Mixed cuts, Multicolored, Gold-tone plated', 							(''),										3, 				0, 				10, 		84, 				'F'),
	('creativity pendant', 						'necklace', 	'75.00', 	'White, Rose gold-tone plated', 									  	(''),										3, 				0, 				10, 		84, 				'F'),
	('millenia necklace', 						'necklace', 	'550.00', 	'Oversized crystals, Octagon cut, Green, Gold-tone plated', 			(''),										3, 				0, 				10, 		84, 				'F'),
	('luna drop earrings', 						'earrings', 	'175.00', 	'Moon, White, Rhodium plated', 									  		(''),										3, 				0, 				10, 		84, 				'F'),
	('hyperbola drop earrings',	 				'earrings', 	'230.00', 	'Heart, Blue, Rhodium plated', 									  		(''),										3, 				0, 				10, 		84, 				'F'),
	('lucent cocktail ring', 					'ring', 		'250.00', 	'Octagon cut, Green', 									  				(''),										3, 				0, 				10, 		84, 				'F'),
	('luna cocktail ring', 						'ring', 		'175.00', 	'Moon, White, Rhodium plated', 									  		(''),										3, 				0, 				10, 		84, 				'F'),
	('florere cocktail ring', 					'ring', 		'400.00', 	'Pavé, Flower, Pink, Gold-tone plated', 								(''),										3, 				0, 				10, 		84, 				'F');
